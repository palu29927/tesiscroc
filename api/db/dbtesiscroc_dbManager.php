...
function getConnection() {
	...
	global $db_tesiscroc_db_Url, $db_tesiscroc_db_User, $db_tesiscroc_db_Pass, $db_tesiscroc_db_DbName;
	
	try {
		$dbh = new PDO("mysql:host=".$db_tesiscroc_db_Url.";dbname=".$db_tesiscroc_db_DbName, $db_tesiscroc_db_User, $db_tesiscroc_db_Pass);
